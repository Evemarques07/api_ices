...
@router.post("/", response_model=entradas_schemas.Entrada)
...
@router.get("/", response_model=List[entradas_schemas.Entrada])
...
@router.get("/{entrada_id}", response_model=entradas_schemas.Entrada)
...
@router.put("/{entrada_id}", response_model=entradas_schemas.Entrada)
